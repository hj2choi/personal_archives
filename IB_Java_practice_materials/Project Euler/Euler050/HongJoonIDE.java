import java.io.*;
class HongJoonIDE			//	 Just tried to test
{
//===================================Variables====================================
...
//===================================ExtraMethods====================================
//===================================Returns prime numbers until (long num) in array(long[])====================================
	public static long[] primeNumbersUntil(long num)
	{
		boolean chk = false;
		long[] prime = new long[(int)(num/5)+100];
		prime[0] = 2;
		int roll=1;
		for (long you=1;you<num ;you+=2 )		//for optimum performance
		{
			chk=false;
