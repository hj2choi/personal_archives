public class Shop
{
	java.util.Scanner s = new java.util.Scanner(System.in);
	{
		...
		ShopLoop: while (true)
		{
			...
			System.out.println("");
			System.out.println("			[5] Enchantments");
			System.out.println("");
			...
			if (UserOrder2 == 1)			//weapon
			{
				...
				System.out.println("");
				System.out.println("100.Wood wand $500:		attack 24,    power 18,    difficulty 13");
				System.out.println("");
				System.out.println("101.Silver Knife $2000:	attack 30,    power 21,    difficulty 25");
				System.out.println("");
				System.out.println("102.Wizard Staff $2.5k:	attack 28,    power 24,    difficulty 16");
				System.out.println("");
				System.out.println("103.Spiked Axe $5500:	attack 31,    power 22,    difficulty 20");
				System.out.println("");
				System.out.println("104.Rust Blade $10k:	attack 34,    power 25,    difficulty 24");
				System.out.println("");
				System.out.println("105.BroadSword $18k:	attack 40,    power 30,    difficulty 30");
				System.out.println("");
				System.out.println("106.War Bow $25k:	attack 42,    power 33,    difficulty 20");System.out.println("");
				System.out.println("107.OblivionStaff$37k:	attack 41,    power 40,    difficulty 36");System.out.println("");
				System.out.println("108.MithrillHammer$43k:	attack 46,    power 37,    difficulty 30");System.out.println("");
				System.out.println("109.Elder Wand $72k:	attack 52,    power 42,    difficulty 36");
				UserOrder2 = s.nextInt();
				System.out.println("");
				switch (UserOrder2)
				{
				...
				case 100:
					if (main.money>=500)
					{	main.money = main.money - 500;	 main.wep = "Wood wand"; main.wep_stat[0] = 24;	main.wep_stat[1] = 18; main.difficulty = 13;
						System.out.println("Purchase Successful! Enter any number to escape"); anykey = s.next(); continue ShopLoop;}
					break;
				case 101:
					if (main.money>=2000)
					{ main.money = main.money - 2000;	 main.wep = "Silver Knife"; main.wep_stat[0] = 30;	main.wep_stat[1] = 21; main.difficulty = 25;
						System.out.println("Purchase Successful! Enter any number to escape"); anykey = s.next(); continue ShopLoop;}
					break;
				case 102:
					if (main.money>=2500)
					{	main.money = main.money - 2500;	 main.wep = "Wizard Staff"; main.wep_stat[0] = 28;	main.wep_stat[1] = 24; main.difficulty = 16;
						System.out.println("Purchase Successful! Enter any number to escape"); anykey = s.next(); continue ShopLoop;	}
					break;
				case 103:
					if (main.money>=5500)
				...
				case 109:
					if (main.money>=72000)
					{	main.money = main.money - 72000;	 main.wep = "Elder Wand"; main.wep_stat[0] = 52;	main.wep_stat[1] = 42; main.difficulty = 36;
						System.out.println("Purchase Successful! Enter any number to escape"); anykey = s.next(); continue ShopLoop;	}
					break;
				}
			}
			...
			else if (UserOrder2 ==2)
			{
				...
				System.out.println("");
				System.out.println("201.T-shirt $300:		def 2");System.out.println("");
				System.out.println("202.Wizard Robe $1100:		def 5");System.out.println("");
				System.out.println("203.Leather Armour $3500:	def 9,	hp 20");System.out.println("");
				System.out.println("204.Chain Mail $7500:		def 12,	Enduarance 2,	 hp 20");System.out.println("");
				System.out.println("205.Metal Plates $17k:		def 24,	Endurance 1");System.out.println("");
				System.out.println("206.Platinum Mail $23k:		def 32");System.out.println("");
				System.out.println("207.Vanguard$42k:		def 40,	Endurance 1,	 hp 120");System.out.println("");
				System.out.println("208.Invincibility Cloak $80k:	def 64,	Endurance 3");System.out.println("");
				UserOrder2 = s.nextInt();
				System.out.println("");
				switch (UserOrder2)
				{
					...
					case 201:
					if (main.chrystal>=20)
					{	main.money = main.money - 300;	 main.arm = "T-shirt"; main.wep_stat[2] = 2;	main.wep_stat[6] = 0; main.wep_stat[7] = 0;
						System.out.println("Purchase Successful! Enter any number to escape");anykey = s.next(); continue ShopLoop;	}
					break;
					case 202:
					if (main.money>=1100)
					{	main.money = main.money - 1100;	 main.arm = "Wizard Robe"; main.wep_stat[2] = 5;	main.wep_stat[6] = 0; main.wep_stat[7] = 0;
						System.out.println("Purchase Successful! Enter any number to escape"); anykey = s.next();continue ShopLoop;	}
					break;
					case 203:
					if (main.money>=3500)
					{	main.money = main.money - 3500;	main.arm = "Leather Armour"; main.wep_stat[2] = 9;	main.wep_stat[6] = 0; main.wep_stat[7] = 20;
						System.out.println("Purchase Successful! Enter any number to escape"); anykey = s.next(); continue ShopLoop;	}
					break;
					case 204:
					if (main.money>=7500)
			...
			else if (UserOrder2 ==5)
			{
				...
				System.out.println("");
				/****************************************************Enchantments*************************************************************/
				/*Purchase Method,				Ability
				Crystal					Increase attack(%)
				Money,Crystal		Increase def(money for +, crystal for %)
				Money						Increase  acc(+)
				Crystal					Increase all stats(+)
				Crystal2					Enchantment that shows you Mana of opponent
				Crystal5					Enchantment that reveals stat of opponent (Homenum Revelio)
				Crystal					
				Crystal8					
				Crystal					
				*/
