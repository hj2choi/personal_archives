	...
	Manual(String a)
	{
		Manualloop : while (true)
		{
			...
			case 2:
				...
				System.out.println("There are four attributes in this game, Strength, Agility, Intelligence and Stamina.");
				System.out.println("Each attributes have different characteristics. It is your choice how to raise them.");
				for (int zzz = 0;zzz<3 ;zzz++ )
					System.out.println("");
				System.out.println(" 1. Strength (STR)");
				System.out.println("Increase your maximum damage.");
				System.out.println("");
				System.out.println(" 2. Agility (AGI)");
				System.out.println("Agility stabilizes damage fluctuation. Also increases accuracy and speed.");
				System.out.println("");
				System.out.println(" 3. Intelligence (INT)");
				System.out.println("Intelligence increases mana point and special attack damage.");
				System.out.println("");
				System.out.println(" 4. Stamina (STA)");
				System.out.println("Increases health and defence.");
				for (int zzz = 0;zzz<4 ;zzz++ )
					System.out.println("");
				System.out.println("TIP : In a late game, balancing attributes out gets more important.");
				System.out.println("");
			...
			case 3:
				...
				System.out.println("Deals extra damage. It penetrates enemy defence.");
