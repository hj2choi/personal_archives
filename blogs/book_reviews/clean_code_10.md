...
## 클래스 체계
Java convention에 따르면 가장 먼저 변수 목록이 나옴.  
https://docs.oracle.com/javase/specs/jls/se19/html/jls-8.html#jls-8.3.1.1  

- static public  
- static private  
- private instance  
- public instance (barely needed)  

변수목록 다음에는 public method가 나온다. private 함수는 자신을 호출 하는 공개 함수 직후에 나온다.  
...
## 클래스는 작아야 한다!
(테스트 코드가 가독성이 우선인것과 마찬가지로...) <b>클래스는 첫째! 작아야한다. 둘째! 작아야한다. 더 작아야 한다.</b>  
